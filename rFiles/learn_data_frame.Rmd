...
```{r}
hist(data_frame_of_integrated_profile[[1]], xlab='range', main='mean_of_integrated_profile', col='blue',100)
...
```{r}
plot(data_frame_of_DN_SNR_curve$Mean, data_frame_of_DN_SNR_curve$Standard_Deviation, col='blue')
```
